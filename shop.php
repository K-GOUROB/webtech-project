...
<section class="search">
  <div class="input-group">
    <input type="text" id="searchArea" class="form-control" placeholder="Search by area">
    <div class="input-group-append">
      <button class="btn btn-outline-secondary search-btn" type="button"><i class="fa fa-search"></i></button>
    </div>
  </div>
  <div class="dropdown">
    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="areaDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-map-marker-alt"></i> Select an area</button>
    <div class="dropdown-menu" aria-labelledby="areaDropdown">
      <form class="px-4 py-3">
        <div class="form-group">
          <label for="dropdownSearch">Search for an area</label>
          <input type="text" class="form-control" id="dropdownSearch" placeholder="Type an area name">
        </div>
      </form>
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="#">Dhaka</a>
      <a class="dropdown-item" href="#">Cumilla</a>
